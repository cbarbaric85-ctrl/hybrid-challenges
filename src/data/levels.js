...
export const LEVELS = [
  ...
  {id:10, name:'OMEGA HYBRID',        desc:'The ultimate fusion. One god-beast. This ends here.',          animals:['sibtiger','orca','pbear'],     diceBonus:3,useMax:true, isHard:true,isBoss:true, arena:'volcanic'},
  ...
  {id:15, name:'TITAN CONVERGENCE',   desc:'Every legendary force combined. This is the mythic threshold.',animals:['kraken','hydra','chimera'],     diceBonus:4,useMax:true, isHard:true, isBoss:true, arena:'volcanic'},
  ...
  {id:20, name:'PANTHEON SUPREME',    desc:'All gods united. The final trial. Prove you are worthy.',      animals:['zeus','poseidon','hades'],       diceBonus:5,useMax:true, isHard:true, isBoss:true, isFinal:true, arena:'celestial'},
];
